...
export async function main(): Promise<void> {
  ...
  // 0.5 升级 tripwire（仅 prod 强校验；dev 跳过避免开发中断）
  if (process.env.APP_ENV === "prod") enforceUpgradeTripwire();
...
/*
 * 修改记录：
 *   2026-08-24 补齐未完成清单：集成 upgrade-state tripwire + backfill-container-configs
 */
